...
class ModelTrainingPipeline():
    ...
    def train(self, run_name = "XGB Final"):
        ...
        with mlflow.start_run(
            ...
            train_metrics = self._calculate_metrics(target_metrics, pred_train, self.y_train, "train")
            pred_test = xgb_model_best.predict_proba(self.X_test)
            test_metrics = self._calculate_metrics(target_metrics, pred_test, self.y_test, "test")
